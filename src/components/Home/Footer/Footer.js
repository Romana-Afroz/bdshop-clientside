        ...
        <div className="row mt-5">
          <div className="col-md-3 my-3 contact">
            ...
            <div className="contact-details">
              ...
              <p>Email <span className='brand-color'> bdshop@gmail.com</span></p>
              <p>Phone <span className='brand-color'> +65 123 456 789</span></p>
              <p>Fax <span className='brand-color'> +65 123 456 789</span></p>
              <p>Website <span className='brand-color'> http://www.bdshop.com</span></p>
            </div>
          </div>
        ...
        <div className="container">
          <div className="pt-3 d-flex justify-content-between">
            <div className="copyright-text">
              <small>Copyright {(new Date()).getFullYear()} by bdshop2021 | All Rights Reserved</small>
            </div>
